			...
			<div className="space-y-6">
					...
					<ul className="list-disc pl-6 space-y-2">
						...
						<li>
							<p>
								...
								&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Cartomania.
							</p>
						</li>
						<li>
							<p>
						...
						<li>
							<p>
								<strong>Website</strong> refers to Cartomania, accessible from{' '}
								<a href="https://cartomania.thomasgendron.fr" rel="external nofollow noopener" target="_blank">
									https://cartomania.thomasgendron.fr
								</a>
							</p>
						</li>
						<li>
				...
				<section className="prose max-w-none">
					...
					<ul className="list-disc pl-6">
						<li className="mb-2">
							By email:{' '}
							<a href="mailto:tomspace.800@gmail.com" className="text-blue-600 hover:underline">
								tomspace.800@gmail.com
							</a>
						</li>
					</ul>
				</section>
